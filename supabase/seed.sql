...
-- 레이드 정보 생성
INSERT INTO public.raids (name, difficulty, step, level, is_biweekly, gold) VALUES
('발탄', '노말', 1, 1415, false, 500),
('발탄', '노말', 2, 1415, false, 700),
('발탄', '하드', 1, 1445, false, 700),
('발탄', '하드', 2, 1445, false, 1100),
('비아키스', '노말', 1, 1430, false, 600),
('비아키스', '노말', 2, 1430, false, 1000),
('비아키스', '하드', 1, 1460, false, 900),
('비아키스', '하드', 2, 1460, false, 1500),
('쿠크세이튼', '노말', 1, 1475, false, 600),
('쿠크세이튼', '노말', 2, 1475, false, 900),
('쿠크세이튼', '노말', 3, 1475, false, 1500),
('아브렐슈드', '노말', 1, 1490, false, 1500),
('아브렐슈드', '노말', 2, 1490, false, 1500),
('아브렐슈드', '노말', 3, 1500, false, 1500),
('아브렐슈드', '노말', 4, 1520, true, 2500),
('아브렐슈드', '하드', 1, 1540, false, 2000),
('아브렐슈드', '하드', 2, 1540, false, 2000),
('아브렐슈드', '하드', 3, 1550, false, 2000),
('아브렐슈드', '하드', 4, 1560, true, 3000),
('일리아칸', '노말', 1, 1580, false, 1500),
('일리아칸', '노말', 2, 1580, false, 2000),
('일리아칸', '노말', 3, 1580, false, 4000),
('일리아칸', '하드', 1, 1600, false, 1750),
('일리아칸', '하드', 2, 1600, false, 2500),
('일리아칸', '하드', 3, 1600, false, 5750),
('카멘', '노말', 1, 1610, false, 3500),
('카멘', '노말', 2, 1610, false, 4000),
('카멘', '노말', 3, 1610, false, 5500),
('카멘', '하드', 1, 1630, false, 5000),
('카멘', '하드', 2, 1630, false, 6000),
('카멘', '하드', 3, 1630, false, 9000),
('카멘', '하드', 4, 1630, true, 21000),
('카양겔', '노말', 1, 1540, false, 1000),
('카양겔', '노말', 2, 1540, false, 1500),
('카양겔', '노말', 3, 1540, false, 2000),
('카양겔', '하드', 1, 1580, false, 1500),
('카양겔', '하드', 2, 1580, false, 2000),
('카양겔', '하드', 3, 1580, false, 3000),
('혼돈의 상아탑', '노말', 1, 1600, false, 1500),
('혼돈의 상아탑', '노말', 2, 1600, false, 1750),
('혼돈의 상아탑', '노말', 3, 1600, false, 2500),
('혼돈의 상아탑', '노말', 4, 1600, false, 3250),
('혼돈의 상아탑', '하드', 1, 1620, false, 2000),
('혼돈의 상아탑', '하드', 2, 1620, false, 2500),
('혼돈의 상아탑', '하드', 3, 1620, false, 4000),
('혼돈의 상아탑', '하드', 4, 1620, false, 6000);